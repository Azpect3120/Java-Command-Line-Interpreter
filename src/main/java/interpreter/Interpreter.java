...
public class Interpreter {
    ...
    private static Class findClassName (String keyword, boolean inEditor) {
        ...
        if (!inEditor) {
            classes = new Class[] {
                    ChangeDirectory.class, Create.class, Current.class, Delete.class, ListDirectories.class, ListDisks.class, Open.class, Rename.class, SwitchDisk.class, Compile.class, Attributes.class, Permissions.class,
                    OpenEditor.class,
